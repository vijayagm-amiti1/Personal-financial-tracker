...
VALUES
    ...
    ('00000000-0000-0000-0000-000000005205', (SELECT user_id FROM _seed_ctx), 'Weekly Movie Night', 'expense', 650.00, '00000000-0000-0000-0000-000000005018', '00000000-0000-0000-0000-000000005031', 'weekly', DATE '2026-03-19', NULL, DATE '2026-03-26', true),
    ('00000000-0000-0000-0000-000000005206', (SELECT user_id FROM _seed_ctx), 'Weekly Shopping Run', 'expense', 1200.00, '00000000-0000-0000-0000-000000005020', '00000000-0000-0000-0000-000000005030', 'weekly', DATE '2026-03-19', NULL, DATE '2026-03-26', true),
    ('00000000-0000-0000-0000-000000005207', (SELECT user_id FROM _seed_ctx), 'Rapido Weekly Payout', 'income', 4200.00, '00000000-0000-0000-0000-000000005011', '00000000-0000-0000-0000-000000005030', 'weekly', DATE '2026-03-19', NULL, DATE '2026-03-26', true);
