...
public class NotificationController {
    ...
    @GetMapping
    public ResponseEntity<List<NotificationResponse>> getAllNotificationsByUserId(@RequestParam UUID userId) {
    ...
    @DeleteMapping
    public ResponseEntity<Void> deleteAllNotificationsByUserId(@RequestParam UUID userId) {
