...
public class ReportController {
    ...
    public ResponseEntity<List<DailyReportDTO>> getMonthlyDailyReport(@RequestParam UUID userId,
    ...
    public ResponseEntity<List<CategorySpendingReportDTO>> getMonthlyCategorySpendingReport(@RequestParam UUID userId,
                                                                                            @RequestParam UUID accountId,
                                                                                            @RequestParam int month,
                                                                                            @RequestParam int year) {
